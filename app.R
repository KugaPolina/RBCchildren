...
# Diagnosis + Organomegaly + 
#   BMI + Age + Temperature + V_weight
...
ui <- fluidPage(
  ...
  headerPanel(i18n$t('Прогностический калькулятор дозы эритроцитной взвеси для детей в онкогематологии')),
...
# Combine the selected variables into a new data frame
  ...
  #   lang <- ifelse(as.numeric(input$change) %% 2, "ru", "en")
